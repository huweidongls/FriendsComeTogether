...
public class ApplyHuoDongChooseDateAdapter extends RecyclerView.Adapter<ApplyHuoDongChooseDateAdapter.ViewHolder> {

    private Context context;
    private List<ApplyChooseDateModel.ObjBean> data;
    private ChooseDatePostionListener chooseDatePostionListen;
    public ApplyHuoDongChooseDateAdapter(List<ApplyChooseDateModel.ObjBean> data){
        this.data =data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ApplyHuoDongChooseDateAdapter.ViewHolder holder = new ApplyHuoDongChooseDateAdapter.ViewHolder(view);
        return holder;
    }
