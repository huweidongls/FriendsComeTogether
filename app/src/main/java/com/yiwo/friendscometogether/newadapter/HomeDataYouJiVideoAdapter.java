...
public class HomeDataYouJiVideoAdapter extends RecyclerView.Adapter<HomeDataYouJiVideoAdapter.ViewHolder> {

    private Context context;
    private List<HomeDataYouJiVideoModel.ObjBean> data;
    private SpImp spImp;
    private String uid = "";

    public HomeDataYouJiVideoAdapter(List<HomeDataYouJiVideoModel.ObjBean> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_fragment_home_rv_youji_video, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (data.get(position).getVList().size()>0){
            ...
            holder.rv_video.setLayoutManager(manager);
            HomeListVideoInYouJiAdapter adapterVideos = new HomeListVideoInYouJiAdapter(data.get(position).getVList());
            holder.rv_video.setAdapter(adapterVideos);
        }else {
