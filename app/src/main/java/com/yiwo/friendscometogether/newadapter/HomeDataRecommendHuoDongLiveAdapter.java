...
public class HomeDataRecommendHuoDongLiveAdapter extends RecyclerView.Adapter<HomeDataRecommendHuoDongLiveAdapter.ViewHolder> {

    private Context context;
    private List<HomeDataBannerHuoDongLiveModel.ObjBean.ActivityBean> data;
    private SpImp spImp;
    private String uid = "";
    private LiveListAdapterListener listener;
    public HomeDataRecommendHuoDongLiveAdapter(List<HomeDataBannerHuoDongLiveModel.ObjBean.ActivityBean> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_fragment_home_rv_tuijian_huodong_new, parent, false);
