package com.yiwo.friendscometogether.location.activity;
...
import com.yiwo.friendscometogether.location.helper.NimGeocoder;
import com.yiwo.friendscometogether.location.helper.NimLocationManager;
import com.yiwo.friendscometogether.location.model.NimLocation;
...
//	private static final String TAG = "LocationAmapActivity";
    ...
    private void initLocation() {
        ...
        LatLng latlng;
        if (location == null) {
            latlng = new LatLng(200, 200);
            Log.d("asss","location == null");
        } else {
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.location_pin) {
            setPinInfoPanel(!isPinInfoPanelShow());

        } else if (i == R.id.location_info) {
