...
public class ModifyIntercalationPicAdapter extends RecyclerView.Adapter<ModifyIntercalationPicAdapter.ViewHolder> {

    private Context context;
    private List<ModifyIntercalationModel.ObjBean.ImagesArrBean> data;
    ...
    public ModifyIntercalationPicAdapter(List<ModifyIntercalationModel.ObjBean.ImagesArrBean> data) {
        this.data = data;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv.setText(data.get(position).getFfptitle());
