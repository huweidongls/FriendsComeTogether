...
public class PersonsWhoHeartMeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(PersonsWhoHeartMeActivity.this);
        spImp = new SpImp(PersonsWhoHeartMeActivity.this);
    ...
    private void initRefresh() {
        refresh_layout.setRefreshHeader(new ClassicsHeader(PersonsWhoHeartMeActivity.this));
        refresh_layout.setRefreshFooter(new ClassicsFooter(PersonsWhoHeartMeActivity.this));
        refresh_layout.setOnRefreshListener(new OnRefreshListener() {
            @Override
            public void onRefresh(@NonNull final RefreshLayout refreshLayout) {
                ViseHttp.POST(NetConfig.heartList)
                        .addParam("app_key", getToken(NetConfig.BaseUrl + NetConfig.heartList))
    ...
    private void initRv() {
        GridLayoutManager manager = new GridLayoutManager(PersonsWhoHeartMeActivity.this,4);
