...
public class PayRankActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spImp = new SpImp(PayRankActivity.this);
        initData();
    }
    ...
    private void initData() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(PayRankActivity.this);
        recyclerView.setLayoutManager(manager);
        recyclerView.setAdapter(adapter);

        refreshLayout.setRefreshHeader(new ClassicsHeader(PayRankActivity.this));
        refreshLayout.setRefreshFooter(new ClassicsFooter(PayRankActivity.this));
