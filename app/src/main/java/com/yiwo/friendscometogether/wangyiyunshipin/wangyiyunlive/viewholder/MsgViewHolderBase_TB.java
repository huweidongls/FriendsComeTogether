...
import com.yiwo.friendscometogether.wangyiyunshipin.wangyiyunlive.fragment.MsgAdapter;

/**
 * 会话窗口消息列表项的ViewHolder基类，负责每个消息项的外层框架，包括头像，昵称，发送/接收进度条，重发按钮等。<br>
 *     具体的消息展示项可继承该基类，然后完成具体消息内容展示即可。
 */
public abstract class MsgViewHolderBase_TB extends TViewHolder {
    ...
    protected final int getResId() {
        return R.layout.nim_message_item_tb;
    }
