package com.yiwo.friendscometogether.wangyiyunshipin.wangyiyunlive.helper;
...
public class GiftAnimation {
    ...
    private boolean downFree = false;
    ...
    private void checkAndStart() {
        ...
        if(downFree) {
            Log.d("sssss","down_isfree");
            startAnimation(downView, downAnimatorSet);
        } else {
            Log.d("sssss","down_isNOTfree");
