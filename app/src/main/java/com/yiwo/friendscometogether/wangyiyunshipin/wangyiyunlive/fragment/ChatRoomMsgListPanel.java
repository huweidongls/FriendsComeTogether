...
import com.yiwo.friendscometogether.wangyiyunshipin.wangyiyunlive.viewholder.ChatRoomMsgViewHolderFactory;
import com.yiwo.friendscometogether.wangyiyunshipin.wangyiyunlive.viewholder.MsgViewHolderBase_TB;
    ...
    private void refreshViewHolderByIndex(final int index) {
        container.activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (tag instanceof MsgViewHolderBase_TB) {
                    MsgViewHolderBase_TB viewHolder = (MsgViewHolderBase_TB) tag;
