...
public class BannerLayout extends FrameLayout {/////注意！！调用adapter的NotifyChanged方法将不会循环加载
    ...
    private OnCurrentChangeListenner onCurrentChangeListenner;
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                onCurrentChangeListenner.onCurrentChange(mLayoutManager.getCurrentPosition());
                refreshIndicator();
            }
        });
        hasInit = true;
    ...
    public void setOnCurrentChangeListenner(OnCurrentChangeListenner onCurrentChangeListenner) {
        this.onCurrentChangeListenner = onCurrentChangeListenner;
    }
    ...
    public interface OnCurrentChangeListenner{
        void onCurrentChange(int position);
    }
